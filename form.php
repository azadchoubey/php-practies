    ...
    <div class="form">
        <from id="text">
            ...
            <table style="margin-left:30px;">
                ...
                <tr>
                    <td> <b>Father Name's </b> <input type="text" style=" margin-left: 413px;  width:420px;" requied>
                        <p class="red1"><u> Note: </u> Do not use prefix such Shri or Mr etc. </p>
                    </td>
                </tr>
                <tr>
                    <td> <b>Mother Name's </b> <input type="text" style=" margin-left: 405px;  width:420px;" requied>
            ...
            <table style="margin-left:30px;">
                ...
                <p class="red1" style="margin-bottom:2px; margin-left:532px;"><u> Note </u>: Do not enter your name again in address
                    flieds. </p>
                ...
                <td> <b>Email id :</b> <input type="text" style=" margin-left: 445px;  width:420px;" requied>

                </td>
                </tr>
                </td>
                </tr>
                <td> <b>Confirm Email id :</b> <input type="text" style=" margin-left: 395px;  width:420px;" requied>
                </td>
                </tr>
